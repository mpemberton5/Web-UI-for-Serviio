...
<div style="border:1px solid gray; width:98%; margin-bottom: 1em; padding: 10px">
    <div id="rmt3" class="tabcontent">
        ...
        <br>
        <br>
        <input type="submit" id="checkPortMapping" name="checkPortMapping" value="<?php echo tr('tab_remote_internet_access_button_check_port_mapping','Check connectivity status')?>" class="ui-button ui-widget ui-state-default ui-corner-all btn-small" />
