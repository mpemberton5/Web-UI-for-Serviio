...
<div style="border:1px solid gray; width:98%; margin-bottom: 1em; padding: 10px">
    <div id="svrstat1" class="tabcontent">
        ...
        <br>
        <input type="submit" name="start" id="start" value="<?php echo tr('tab_status_button_start_server','Start server')?>" <?php echo $startDisabled?> onclick="return confirm('Are you sure you want to start the server');" class="ui-button ui-widget ui-state-default ui-corner-all btn-small" />
        <input type="submit" name="stop" id="stop" value="<?php echo tr('tab_status_button_stop_server','Stop server')?>" <?php echo $stopDisabled?> onclick="return confirm('Are you sure you want to stop the server');" class="ui-button ui-widget ui-state-default ui-corner-all btn-small" />
    </div>
</div>
...
<tr valign="top">
    ...
    <td width="100">
<input type="submit" name="refresh" value="Refresh" class="ui-button ui-widget ui-state-default ui-corner-all btn-small" />
<br>
<input type="button" name="remove" value="Remove" onclick="if(confirm('Are you sure you want to remove selected renderers')) { deleteProfileRow('rendererTable'); }" class="ui-button ui-widget ui-state-default ui-corner-all btn-small" />
    </td>
</tr>
</table>
